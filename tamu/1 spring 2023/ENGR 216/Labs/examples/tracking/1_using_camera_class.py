...
'''
Demo of using TrackingCamera to take a snapshot and save it
using a smart with statement (context manager) to auto stop camera before exiting
'''
## import cmera
...
def run_camera():
    ...
    with TrackingCamera(**camera_kwargs) as camera:
        ...
        camera.write_frame_to_image(frame_no, frame, filename='example_1.png')
