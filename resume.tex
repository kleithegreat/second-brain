...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Visualizing and organizing observational data gathered from the Neil Gehrels Swift Observatory}
        \resumeItem{Developing and maintaining a full stack web app displaying SNe light curves}
...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Managed the receiving and usage of parts for the production floor}
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{Showcased to the Texas A\&M Astronomy Department}
          \resumeItemListEnd
      \resumeProjectHeading
        {\textbf{RISC Processor} $|$ \emph{Logisim}}{March 2024}
        \resumeItemListStart
          \resumeItem{Designed a fully functional 64-bit x86-like RISC processor as a Logisim circuit}
